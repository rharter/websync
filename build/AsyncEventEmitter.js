        ...
        var wrapper = function () {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, listener.apply(void 0, args)];
                        case 1:
                            _a.sent();
    ...
    AsyncEventEmitter.prototype.emit = function (event) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this._events.hasOwnProperty(event) && this._events[event].length)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this._events[event].reduce(function (p, listener) { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
